ItemEvents.tooltip(event => {
  ...
  event.add(['reforgedutils:empty_bloodbag'], ["", '§eINFO: §7Can be filled by yourself by right-clicking, or fill it by shift right-clicking another player.'])
  event.add(['reforgedutils:full_bloodbag'], ["", '§eINFO: §7Restores 6 hearts of health after use, has 5s cooldown.'])
  event.add(['reforgedutils:energy_drink'], ["", '§eINFO: §7Grants 20 seconds of Speed and Haste II'])
  event.add(['reforgedutils:medkit'], ["", '§eINFO: §7Restores 10 hearts of health after use, has 10s cooldown.'])
  event.add(['reforgedutils:painkillers'], ["", '§eINFO: §7Restores 8 hearts of health after use, has 30s cooldown.'])
